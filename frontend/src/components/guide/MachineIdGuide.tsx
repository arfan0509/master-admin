...
interface MachineIDGuideProps {
  isOpen: boolean;
  onClose: () => void;
}

const MachineIDGuide: React.FC<MachineIDGuideProps> = ({ isOpen, onClose }) => {
      ...
      <div className="bg-white w-11/12 md:w-3/4 lg:w-2/3 xl:w-3/4 2xl:w-1/2 max-h-screen overflow-y-auto rounded-lg shadow-lg p-6 relative">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-extrabold text-[#385878]">
            Panduan Penggunaan Halaman Machine ID
          </h1>
        ...
        <div className="text-gray-800 space-y-4 leading-[1.6rem]">
          <p>
            Halaman ini digunakan untuk mengelola data Machine ID. Pengguna
            dapat menambah, mengedit, menampilkan, mencari, menyaring, serta
            mengekspor data Machine ID. Berikut adalah langkah-langkah
            penggunaan fitur yang ada di halaman{" "}
            <strong className="text-[#385878]">Machine ID</strong>:
          </p>
          ...
          <div>
            ...
            <p>
              Saat pertama kali membuka halaman, data Machine ID akan
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                <strong className="text-[#385878]">Icon Group:</strong> Grup
                ikon mesin.
              </li>
              <li>
                <strong className="text-[#385878]">Icon ID:</strong> ID ikon
                mesin.
              </li>
              <li>
                <strong className="text-[#385878]">Country ID:</strong> Kode
                negara.
              </li>
              <li>
                <strong className="text-[#385878]">State ID:</strong> Kode
                provinsi.
              </li>
              <li>
                <strong className="text-[#385878]">City ID:</strong> Kode kota.
              </li>
              <li>
                <strong className="text-[#385878]">Region ID:</strong> Kode
                wilayah.
              </li>
              <li>
                <strong className="text-[#385878]">Latitude:</strong> Garis
                lintang lokasi mesin.
              </li>
              <li>
                <strong className="text-[#385878]">Longitude:</strong> Garis
                bujur lokasi mesin.
              </li>
              <li>
                <strong className="text-[#385878]">Active:</strong> Status aktif
                atau tidak dari mesin.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              Pengguna dapat mencari Machine ID tertentu dengan menggunakan
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                <strong className="text-[#385878]">Object ID</strong>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              Untuk menambahkan Machine ID baru, ikuti langkah-langkah berikut:
            </p>
            <ol className="list-decimal list-inside">
              ...
              <li>
                ...
                <strong className="text-[#385878]">Add MachineID</strong> dengan
                informasi berikut:
              </li>
              <ul className="list-disc ml-6">
                ...
                <li>
                  <strong className="text-[#385878]">Object ID:</strong> ID
                  objek mesin (maksimum 10 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Object Name:</strong> Nama
                  objek mesin (maksimum 50 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Icon Group:</strong> Grup
                  ikon mesin (maksimum 6 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Icon ID:</strong> ID ikon
                  mesin (maksimum 6 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Country ID:</strong> Kode
                  negara mesin (pilih dari dropdown).
                </li>
                <li>
                  <strong className="text-[#385878]">State ID:</strong> Kode
                  negara bagian atau provinsi (maksimum 3 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">City ID:</strong> Kode kota
                  mesin (maksimum 3 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Region ID:</strong> Kode
                  wilayah mesin (pilih dari dropdown).
                </li>
                <li>
                  <strong className="text-[#385878]">
                    Latitude & Longitude:
                  </strong>{" "}
                  Lokasi mesin dalam bentuk koordinat geografis.
                </li>
                <li>
          ...
          <div>
            ...
            <p>Untuk mengedit data Machine ID:</p>
            <ol className="list-decimal list-inside">
              <li>
              ...
              <li>
                Modal <strong className="text-[#385878]">Edit MachineID</strong>{" "}
