...
interface MachineGroupGuideProps {
  isOpen: boolean;
  onClose: () => void;
}

const MachineGroupGuide: React.FC<MachineGroupGuideProps> = ({
  isOpen,
  onClose,
}) => {
      ...
      <div className="bg-white w-11/12 md:w-3/4 lg:w-2/3 xl:w-3/4 2xl:w-1/2 max-h-screen overflow-y-auto rounded-lg shadow-lg p-6 relative">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-extrabold text-[#385878]">
            Panduan Penggunaan Halaman Machine Group
          </h1>
        ...
        <div className="text-gray-800 space-y-4 leading-[1.6rem]">
          <p>
            Halaman ini digunakan untuk mengelola data Machine Group. Pengguna
            dapat menambah, mengedit, menampilkan, mencari, menyaring, serta
            mengekspor data grup mesin. Berikut adalah langkah-langkah
            penggunaan fitur yang ada di halaman{" "}
            <strong className="text-[#385878]">Machine Group</strong>:
          </p>
          ...
          <div>
            ...
            <p>
              Saat pertama kali membuka halaman, data grup mesin akan
          ...
          <div>
            ...
            <p>
              Pengguna dapat mencari grup mesin tertentu dengan menggunakan
              kolom pencarian di bagian atas tabel. Data akan difilter secara
              dinamis sesuai dengan kata kunci yang dimasukkan, berdasarkan:
            </p>
            <ul className="list-disc list-inside">
              <li>
          ...
          <div>
            ...
            <p>
              Untuk menambahkan grup mesin baru, ikuti langkah-langkah berikut:
            </p>
            <ol className="list-decimal list-inside">
              ...
              <li>
                ...
                <strong className="text-[#385878]">Add Machine Group</strong>{" "}
              ...
              <ul className="list-disc ml-6">
                ...
                <li>
                  <strong className="text-[#385878]">Object Group:</strong> Grup
                  mesin (maksimal 6 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Description:</strong>{" "}
                  Deskripsi grup mesin (maksimal 50 karakter).
                </li>
                <li>
                  <strong className="text-[#385878]">Status Active:</strong>{" "}
                  Tentukan apakah grup mesin aktif atau tidak.
                </li>
              </ul>
              <li>
          ...
          <div>
            ...
            <p>Untuk mengedit data grup mesin:</p>
            <ol className="list-decimal list-inside">
              <li>
              ...
              <li>
                Modal{" "}
                <strong className="text-[#385878]">Edit Machine Group</strong>{" "}
...
export default MachineGroupGuide;
